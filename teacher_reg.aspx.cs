...
public partial class teacher_reg : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (temp == 0)
            {
                string insertQuery = "insert into [Table] (Username,Password,Confirm_Password,cat) values (@un ,@pswrd ,@cnpass,@categry)";
                ...
                com.Parameters.AddWithValue("@categry", DropDownList_Category.SelectedItem.ToString());
                ...
                Response.Redirect("teacher_reg.aspx");
            }
