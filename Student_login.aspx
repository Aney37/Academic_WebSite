...
<body>
    ...
    <aside id="about" class=" left"> <!-- Text Section Start -->
    	<h1 id="logotitle">Student Login</h1><!-- Replace all text with what you want -->
        <br/>
        <br/>
       <br/>
        <asp:panel defaultbutton="Button1" runat="server">           
                    ...
                    <table border="1" class="auto-style21">
                        <tr>
                            <td   class="auto-style22" style="font-size: 18px">UserName:</td>
                         ...
                         <tr>
                            <td   class="auto-style22" style="font-size: 18px">Year:</td>
                            <td  class="auto-style19">
                                <asp:TextBox ID="TextBox1" runat="server"  class =" txtbox" Height="25px" Width="270px"></asp:TextBox>
                        ...
                        <tr>
                            <td   class="auto-style22" style="font-size: 18px">Password:</td>
                            <td  class="auto-style19">
                     ...
                     <tr>
                        <td class="auto-style22">
                            <asp:Button ID="Button1" runat="server" BackColor="Fuchsia" ForeColor="#6666FF" Height="32px" Text="Login" Width="100px" class="styled-button" OnClick="Button1_Click" />
                        </td>
                         <td class="auto-style19">
                    ...
                    <tr>
                        <td class="auto-style22">
                            <p style="color:chocolate; width: 131px;"><span><h1>New User ???</h1></span>
                                <p>
                                </p>
                                <p>
                                </p>
                        ...
                        <td class="auto-style19">
                            <p style="color:chocolate"><a href="student_reg.aspx" target="_blank"><h1>Registration here.</h1></a>
                                <p>
                                </p>
                                <p>
                                </p>
