<%@ Page Language="C#" AutoEventWireup="true" CodeFile="teacher_reg.aspx.cs" Inherits="teacher_reg" %>
...
<body>
    ...
    <aside id="about" class=" left"> <!-- Text Section Start -->
    	<h3>Teacher Registration</h3><!-- Replace all text with what you want -->
        <asp:panel defaultbutton="Button1" runat="server">           
                    ...
                    <table border="1" class="auto-style21">
                        ...
                        <tr>
                            <td   class="auto-style19" style="font-size: 18px">Confirm Password:</td>
                            <td  class="auto-style19">
                        ...
                        <tr>
                            <td   class="auto-style19"style="font-size: 18px">Category:</td>
                            <td  class="auto-style19">
                                <asp:DropDownList ID="DropDownList_Category" runat="server" class =" txtbox" Height="30px" Width="290px">
                            ...
                            <td class="auto-style50" style="font-size: 18px">
                                 <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="DropDownList_Category" ErrorMessage="Select Category." ForeColor="Red" InitialValue="Select Category"></asp:RequiredFieldValidator>
                            </td>
                            
                        </tr>
                        <tr>
                            <td class="auto-style19" style="font-size: 18px">Course Name:</td>
                            <td class="auto-style19">
                                <asp:TextBox ID="TextBox6" runat="server" class=" txtbox" Height="25px" Width="270px"></asp:TextBox>
                            </td>
                            <td class="auto-style50" style="font-size: 18px">
                                 <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="TextBox6" ErrorMessage="Course Name is required." ForeColor="Red"></asp:RequiredFieldValidator>
                            </td>
                        </tr>
                        <tr>
